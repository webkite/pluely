...
const osInstructions: Record<string, Instructions> = {
  macos: {
    ...
    description:
      "PocketCrew needs permission to capture your screen's audio. Clicking the button will open System Settings.",
    buttonText: "Open System Settings",
    manualTitle: "If permission is not granted automatically:",
    manualSteps:
      "1. Go to System Settings > Privacy & Security > Screen & System Audio Recording.\n2. Find PocketCrew in the list and enable it, if not found then click on + and add PocketCrew.",
    note: "A restart of PocketCrew may be required after granting permission.",
  },
  windows: {
    title: "System Audio Access",
    description:
      "PocketCrew needs to access your system audio. The button below will open the Sound settings panel for troubleshooting.",
    buttonText: "Open Sound Settings",
    manualTitle: "To ensure PocketCrew can capture audio:",
    manualSteps:
  ...
  linux: {
    ...
    description:
      "PocketCrew captures audio using PulseAudio. Please ensure it is configured correctly.",
  ...
  undetermined: {
    ...
    description: "PocketCrew needs permission to capture system audio.",
    buttonText: "Grant Permission",
    manualTitle: "Manual Setup:",
    manualSteps:
      "Please check your system's privacy or sound settings to allow PocketCrew to capture audio.",
  },
};
